...
## Итерация 6. UI и UX Polish
### Цель
Сделать прототип визуально чище, современнее и удобнее для длительной работы со схемой, чатом и экспортом.

### Scope
- сократить визуальный шум над областью диаграммы
- дать схеме приоритет по занимаемому пространству
- добавить возможность скрывать и раскрывать правую панель
- улучшить компоновку правой панели и навигацию по вкладкам
- улучшить иерархию заголовков, статусов и вторичных пояснений
- сделать UI ближе к современному research-tool интерфейсу

### Результат
Схема становится основным рабочим объектом, а управляющие панели перестают конкурировать с ней за внимание и пространство.

### Артефакты
- обновлённый shell layout
- collapsible sidebar
- упрощённый header
- улучшенная visual hierarchy

## Итерация 7. Устойчивость и UX
### Цель
...
- Итерация 7 повышает удобство работы с прототипом как с реальным инструментом, а не только техническим демо.
- Итерация 8 позволяет развивать сам layout engine без переписывания pipeline.